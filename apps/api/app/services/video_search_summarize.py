...
_POSITIVE = {
    "好", "赞", "精彩", "强", "赢", "冠军", "夺冠", "突破", "燃", "惊喜",
    "完美", "成功", "领先", "优势", "棒", "喜", "热爱", "高光",
    "nice", "good", "win", "champion", "great", "amazing", "best",
    "perfect", "breakthrough", "love", "highlight",
}
_NEGATIVE = {
    "差", "败", "输", "争议", "问题", "崩", "丑闻", "质疑", "失败", "弱",
    "落后", "劣势", "痛", "惨", "失误", "崩盘", "抗议",
    "bad", "loss", "lose", "fail", "failed", "controversy", "problem",
    "crash", "weak", "error", "protest",
}
